...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings for arguments.
     *
     * @param firstStr the first part of the silly instance.
     * @param secondStr the second part of the silly instance.
     */
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        Silly o = (Silly) other; // To access .name of other, we need to cast it.
